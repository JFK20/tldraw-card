...
customElements.define('action-handler-tldraw', ActionHandler);

const getActionHandler = (): ActionHandler => {
  const body = document.body;
  if (body.querySelector('action-handler-tldraw')) {
    return body.querySelector('action-handler-tldraw') as ActionHandler;
  }

  const actionhandler = document.createElement('action-handler-tldraw');
